  ...
  head: () => ({
    meta: [
      ...
      { title: "Eventra — Campus Operating System" },
      {
        name: "description",
        content:
          "Eventra is the campus operating system for discovering events, registering, checking in via QR, and reviewing experiences.",
      },
      { name: "author", content: "Eventra" },
      { property: "og:title", content: "Eventra — Campus Operating System" },
      {
        property: "og:description",
        content: "Discover campus events, register, check in via QR, and review experiences — all in one place.",
      },
